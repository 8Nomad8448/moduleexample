      ...
      <div>
        ...
        ";
            ...
            if (twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "hasPermission", [0 => "administer nodes"], "method", false, false, true, 27)) {
                // line 28
                echo "          <br>
          <span class=\"rm_btn\"><a href=\"/admin/nomadmodule/delete/";
                // line 29
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\flag\TwigExtension\FlagCount']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 29), 29, $this->source), "html", null, true));
                echo "?destination=";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\flag\TwigExtension\FlagCount']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["root"] ?? null), 29, $this->source), "html", null, true));
...
";
    ...
    {
        return array (  133 => 35,  124 => 31,  111 => 29,  108 => 28,  106 => 27,  102 => 26,  98 => 25,  93 => 23,  89 => 22,  84 => 20,  80 => 19,  72 => 14,  68 => 13,  64 => 11,  60 => 10,  54 => 7,  49 => 5,  43 => 2,  39 => 1,);
    }
    ...
    <div class=\"col-lg-6 col-md-12 col-sm-12 col-xs-12 cats\">
      <div>
        ...
        {% if user.hasPermission('administer nodes') %}
          <br>
          <span class=\"rm_btn\"><a href=\"/admin/nomadmodule/delete/{{ item.id }}?destination={{ root }}\" class=\"rm_button use-ajax\" data-dialog-type=\"modal\">{{ \"remove\"|trans }}</a><a href=\"{{ item.id }}\" class=\"edit_button\">{{ \"edit\"|trans }}</a></span>
        {% endif %}
      </div>
    </div>
  </div>
